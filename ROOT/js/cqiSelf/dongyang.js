		...
		actionFn.frm_1_2_2 = function(formName) {
			...
			var v1_1 = $form.find("input[name^='self__1_2_2_yn_1'][value='1']").length;
			var v1_0 = $form.find("input[name^='self__1_2_2_yn_1'][value='0']").length;
			var v2_1 = $form.find("input[name^='self__1_2_2_yn_2'][value='1']").length;
			var v2_0 = $form.find("input[name^='self__1_2_2_yn_2'][value='0']").length;

			var v1 = (v1_1 + v1_0) > 0 ? (v1_1 / (v1_1 + v1_0)) : 0;
			var v2 = (v2_1 + v2_0) > 0 ? (v2_1 / (v2_1 + v2_0)) : 0;
			var v3 = (v1 + v2) / 2 * 100;
